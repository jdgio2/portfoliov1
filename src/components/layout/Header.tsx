...
export default function Header() {
  return (
    <section id="header" className="sticky top-0 left-0 right-0 z-50">
      <nav className="justify-center p-1 space-x-36 shadow-sm backdrop-blur-lg bg-gradient-to-t via-white/50 via-20% from-white/20 to-white/100 flex flex-row mx-3 items-center">
        <a
          href="#"
