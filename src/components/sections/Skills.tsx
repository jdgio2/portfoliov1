...
export default function Skills() {
  ...
  return (
    <div className="py-10 flex flex-col items-center mx-1">
      ...
      <button
        className="bg-slate-100 border-indigo-100 py-6 px-8 mx-2 shadow-lg hover:shadow-sm hover:drop-shadow-lg rounded-md"
      ...
      >
        ...
        <p className="font-mono mt-2">CLICK TO EXPAND</p>
      </button>
    </div>
  );
}
